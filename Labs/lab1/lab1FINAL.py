...
#
# Conventionally, you place the "conditional" expression inside parentheses. <- ???????????????
...
# another string.
# note to self - needs to use 'str' for the '+' to work
...
# integer 1 in the 0 index, and the integer 2 in the 1 location. The first
...
# method in the random function is the randint, which returns a random integer
